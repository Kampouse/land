...
export default component$(() => {
  return (
    <div class="flex flex-col justify-center    w-full">
      <h1 class="text-center text-white text-2xl pt-2"> Projects </h1>
        ...
        projects.map((project) => {
          return (<div key={project.name} class="   lg:mx-0 mx-16  flex  flex-col ">
            <div class="flex flex-row gap-2 my-2 pb-2   justify-center content-center self-center">
              <h1 class="flex mt-2 pb-2 md:mt-0  fle-row gap-2 self-left lg:pb-0 md:pb-0 text-white text-2xl underline decoration-4 decoration-[#e6284b]  ">
                {" "}
                {project.name}{" "}
            ...
            <h1 class="  text-center py-2 md:py-2 px-8 lg:w-[31.5em] text-white self-center  mt-2  w-96">
              {project.description}
